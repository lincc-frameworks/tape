...
from lsstseries.analysis.structure_function.schmidt_2010.calculator import (
...
def test_basic_calculation():
    ...
    sf_calculator = Schmidt2010StructureFunctionCalculator(test_t, test_y, test_e, arg_container)
